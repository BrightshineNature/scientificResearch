...
PROJECT_STATUS_APPLY_COMMIT_START = 1
PROJECT_STATUS_APPLICATION_WEB_OVER = 2
PROJECT_STATUS_APPLICATION_COMMIT_OVER = 3
PROJECT_STATUS_APPLICATION_COLLEGE_OVER = 4
PROJECT_STATUS_APPLICATION_SCHOOL_OVER = 5
PROJECT_STATUS_APPLICATION_EXPERT_SUBJECT = 6
PROJECT_STATUS_APPLICATION_REVIEW_START =7
PROJECT_STATUS_APPLICATION_REVIEW_OVER= 8
PROJECT_STATUS_APPROVAL = 9
PROJECT_STATUS_TASK_COMMIT_START = 10
PROJECT_STATUS_TASK_BUDGET_OVER = 11
PROJECT_STATUS_TASK_COMMIT_OVER = 12
PROJECT_STATUS_TASK_FINANCE_OVER = 13
PROJECT_STATUS_TASK_SCHOOL_OVER = 14
PROJECT_STATUS_PROGRESS_COMMIT_START =15
PROJECT_STATUS_PROGRESS_COMMIT_OVER = 16
PROJECT_STATUS_PROGRESS_SCHOOL_OVER = 17
PROJECT_STATUS_FINAL_COMMIT_START = 18
PROJECT_STATUS_FINAL_WEB_OVER = 19
PROJECT_STATUS_FINAL_COMMIT_OVER = 20
PROJECT_STATUS_FINAL_FINANCE_OVER = 21
PROJECT_STATUS_FINAL_SCHOOL_OVER = 22
PROJECT_STATUS_FINAL_EXPERT_SUBJECT = 23
PROJECT_STATUS_FINAL_REVIEW_START = 24
PROJECT_STATUS_FINAL_REVIEW_OVER=25
PROJECT_STATUS_OVER = 26
PROJECT_STATUS_STOP = 27

APPLICATION_START_CONFIRM = "application_start_confirm"
...
TASK_START_CONFIRM="task_start_confirm"
...
EXCELTYPE_INFO_BASESUMMARY_PREVIEW = "info_basesummary_preview"
EXCELTYPE_INFO_HUMANITY_PREVIEW = "info_humanity_preview"
EXCELTYPE_INFO_IMPORTANTPROJECT_PREVIEW = "info_importantproject_preivew"
EXCELTYPE_INFO_LABORATORY_PREVIEW = "info_laboratory_preview"
