...
EXPERT_FINAL_REVIEW_TABLE_CHOICES = (
    (EXPERT_REVIEW_BASICSCIENTIFIC , u"基本科研业务费终审表"),
    (EXPERT_REVIEW_HUMANITIESSOCIAL , u"人文社科科研终审表"),
    (EXPERT_REVIEW_MAJORPROJECT , u"重大项目终审表"),
    (EXPERT_REVIEW_KEYLABORATORY , u"重点实验室专题终审表"),
    (EXPERT_REVIEW_BASICSCIENTIFICSCIENCE, "理科基础科研业务费终审表"),
    (EXPERT_FINAL_REVIEW_FRONT,u"前沿学科基础科研业务费终审表"),
    (EXPERT_REVIEW_OUTSTANDING,u"优秀青年人才基础科研业务费终审表"),
)
