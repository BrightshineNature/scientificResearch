...
class TeacherInfoSetting(models.Model):
    ...
    sex  = models.CharField(max_length=100, blank=False, null=True, choices=SEX_CHOICES, default=SEX_CHOICES[-1], verbose_name="性别")
    ...
    target_type = models.CharField(max_length=100, blank=False, null=True, choices=PROJECT_IDENTITY_CHOICES, default=PROJECT_IDENTITY_CHOICES[-1], verbose_name="支持对象")
    degree = models.CharField(max_length=100, blank=False, null=True, choices=DEGREE_CHOICES, default=DEGREE_CHOICES[-1], verbose_name="学位")
    title = models.CharField(max_length=100, blank=False, null=True, choices=PROFESSIONAL_TITLE_CHOICES, default=PROFESSIONAL_TITLE_CHOICES[-1], verbose_name="职称")
    base_type = models.CharField(max_length=100, blank=False, null=True, choices=RESEARCH_BASES_TYPE_CHOICES, default=RESEARCH_BASES_TYPE_CHOICES[-1], verbose_name="所在研究基地类型")
    position = models.CharField(max_length=100, blank=False, null=True, choices=EXECUTIVE_POSITION_CHOICES, default=EXECUTIVE_POSITION_CHOICES[-1], verbose_name="行政职务")
