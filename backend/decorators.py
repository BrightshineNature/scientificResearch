...
class check_submit_status(object):
    ...
    def get_submit_status(self,pro):
        ...
        is_submited[SUBMIT_STATUS_FINAL] = pro.project_special.final_status and ((pro.project_status.status < PROJECT_STATUS_FINAL_COMMIT_OVER and pro.project_status.status >= PROJECT_STATUS_FINAL_FINANCE_OVER) or (pro.project_status.status == PROJECT_STATUS_PROGRESS_COMMIT_OVER))
